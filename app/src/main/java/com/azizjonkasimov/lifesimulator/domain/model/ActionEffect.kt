...
data class ActionEffect(
    ...
    val applicationsDelta: Int = 0,
    val interviewReadinessDelta: Int = 0,
    val offerProgressDelta: Int = 0,
    val leadsDelta: Int = 0,
    val activeProjectsDelta: Int = 0,
    val completedProjectsDelta: Int = 0,
    val clientTrustDelta: Int = 0,
    val businessReputationDelta: Int = 0,
    val pipelineValueDelta: Int = 0,
